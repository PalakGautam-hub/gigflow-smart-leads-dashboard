...
export function LoginPage() {
  ...
  return (
    ...
    >
      ...
      {/* Orb 1 */}
      <div
        className="absolute top-[-10%] right-[-5%] w-[50%] h-[50%] rounded-full pointer-events-none z-0 animate-float transition-all duration-300"
        style={{
      ...
      {/* Orb 2 */}
      <div
        className="absolute bottom-[-15%] left-[-10%] w-[60%] h-[60%] rounded-full pointer-events-none z-0 transition-all duration-300"
        style={{
